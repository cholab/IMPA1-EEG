...
text(median(x),yl(2),nn{j},'HorizontalAlignment','center','color',[.4 .4 .9])
plot(x,y,'Linewidth',2)

    if j==center_el
    text(xl(1),sc(1),num2str(sc(1)),'VerticalAlignment','Middle','HorizontalAlignment','Right','color',[1 1 1]*.6)    
    text(xl(1),sc(2),num2str(sc(2)),'VerticalAlignment','Middle','HorizontalAlignment','Right','color',[1 1 1]*.6)    
    end
